...
static void mc_cmd_free_register(void);
static void mc_cmd_heap_register(void);
static void mc_cmd_version_register(void);
static void mc_cmd_restart_register(void);
static void mc_cmd_deep_sleep_register(void);
static void mc_cmd_light_sleep_register(void);
#if WITH_TASKS_INFO
static void mc_cmd_tasks_register(void);
#endif

void mc_cmd_system_common_register(void)
{
    mc_cmd_free_register();
    mc_cmd_heap_register();
    mc_cmd_version_register();
    mc_cmd_restart_register();
#if WITH_TASKS_INFO
    mc_cmd_tasks_register();
#endif
}

void mc_cmd_system_sleep_register(void)
{
    mc_cmd_deep_sleep_register();
    mc_cmd_light_sleep_register();
}

void mc_cmd_system_register(void)
{
    mc_cmd_system_common_register();
    mc_cmd_system_sleep_register();
}
